...
export default function PointComponentPresenter (props: any){
  console.log(props.data?.fetchPaymentHistory)
  return (
    <S.Wrapper>
      <S.LeftBox>
        <S.StoreImg>
        ...
        <S.StoreComments>
          ...
          <S.ContentsBox>
            ...
            <S.P></S.P> 
            <S.CreateAt>{getDate_(props.data?.fetchPaymentHistory[0]?.createdAt)}</S.CreateAt>
          </S.ContentsBox>

          <S.PaymentDetails>{props.data?.fetchPaymentHistory[0]?.payStatus}</S.PaymentDetails>

          <S.ContentsBox>
            <S.MenuName>{props.data?.fetchPaymentHistory[0]?.productStatus}</S.MenuName>
            <S.P></S.P> 
            <S.RestaurantName>{props.data?.fetchPaymentHistory[0]?.supplier}</S.RestaurantName>
          </S.ContentsBox>
