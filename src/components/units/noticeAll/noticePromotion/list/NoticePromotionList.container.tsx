// 공지사항 Promotion List Container --- 김치훈

import { useQuery } from "@apollo/client";
import { useRouter } from "next/router";
import NoticePromitionListPresenterPage from "./NoticePromotionList.presenter";
import { FETCH_NOTICE_COUNT,FETCH_NOTICE_CATEGORY_PICK } from "./NoticePromotionList.queries";
...
export default function NoticePromitionListContainerPage() {
  ...
  return <NoticePromitionListPresenterPage
