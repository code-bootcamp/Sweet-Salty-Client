// 공지사항 Promotion List Presenter --- 김치훈
...
import * as S from "./NoticePromotionList.styled";

export default function NoticePromitionListPresenterPage(props: any) {
  return (
    <S.Wrapper>
      <S.Title>공지사항 <S.RightOutline /> 프로모션</S.Title>
      <S.SearchBarBox>
        <SearchBarPage />
      </S.SearchBarBox>
      ...
      <S.ReviewMenuBox>
        ...
        <S.ReviewMenu onClick={props.onClickNoticeEvent}>이벤트</S.ReviewMenu>
        <S.ReviewMenu isNotice={props.isNotice}>프로모션</S.ReviewMenu>
